...
function cambiarFondo(e) {
    if (fondo == 1) {
        imgFondo.style.backgroundImage = 'url(./img/escenario1.png)';
        fondo = 2
    } else if (fondo == 2){
        imgFondo.style.backgroundImage = 'url(./img/escenario2.png)';
        fondo = 3
    } else if (fondo == 3){
        imgFondo.style.backgroundImage = 'url(./img/escenario3.png)';
        fondo = 4
    } else if (fondo == 4){
        imgFondo.style.backgroundImage = 'url(./img/escenario4.png)';
        fondo = 5
    } else if (fondo == 5){
        imgFondo.style.backgroundImage = 'url(./img/escenario5.png)';
        fondo = 1
    }
...
const omorfiaImg = document.getElementById("omorfiaImg")  
const ComicTrailer = document.getElementById("ComicTrailer")  
const sobreNosotrosImg = document.getElementById("sobreNosotrosImg")  
